...
let () =
  ...
  Ok [ Pkg.mllib "src/reagents.mllib";
       ...
       example "queue_test"; example "stack_test"; example "lock_test"; example "benchmark_sharing" ;
       example "dining_philosophers"; example "rec_test"; example "three_way"; example "benchmark_stealing" ;
