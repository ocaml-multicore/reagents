...
let () =
  ...
  Ok [ Pkg.mllib "src/reagents.mllib";
       example "ref_test"; example "swap_test"; example "counter_test";
       example "queue_test"; example "stack_test"; example "lock_test";
       example "dining_philosophers"; example "rec_test"; example "three_way";
